...
public class SalesReviewKegiatanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_review_kegiatan);
        ...
        getSupportActionBar().setTitle("List Review Kegiatan");
